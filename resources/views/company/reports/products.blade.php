...
$(document).ready(function () {
    ...
    var table = $('#datatable').DataTable({
        ...
        responsive: true,
        ajax: {
                  url: "{{url('company/reports/get-products-report')}}",
                  data : function(d){
        ...
        columns: [
              ...
              {data: 'sku', name: 'sku'},       
              {data: 'name', name: 'name'},       
              {data: 'current_stock', name: 'current_stock', className: 'text-center', width:'10%'},
              {data: 'stock_value', name: 'stock_value', className: 'text-center', width:'10%'},
              {data: 'item_value', name: 'item_value', className: 'text-center', width:'10%'},
              {data: 'reorder_point', name: 'reorder_point', className: 'text-center', width:'10%'},                
              {data: 'reorder_amount', name: 'reorder_amount', className: 'text-center', width:'10%'}
          ],
        order: [],
