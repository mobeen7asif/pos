...
<head>
    ...
    <!-- master select css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('css/master_select/multiple-select.css') }}" />
...
<!--    <link rel="stylesheet" href="{{ asset('css/skins/_all-skins.min.css') }}">-->
    ...
    <!--multi transfer css-->
    {{--<link rel="stylesheet" type="text/css" href="{{asset('plugins/multi-transfer/icon_font/css/icon_font.css')}}"/>--}}
    {{--<link rel="stylesheet" type="text/css" href="{{asset('plugins/multi-transfer/css/jquery.transfer.css')}}"/>--}}

    <link href="{{asset('plugins/multi-transfer/css/multi-select.css')}}" media="screen" rel="stylesheet" type="text/css">

    <!-- Bootstrap datatables -->
    <link href="{{ asset('plugins/time_range/time_range.css') }}" rel="stylesheet">
...
<body>        
    ...
    <section id="container">
        ...
        <!-- Admin Header -->
        @include('company.sections.header')
        <!-- Admin Sidebar -->
        @include('company.sections.sidebar')
        
        @yield('content')
        
        <!-- Admin Footer -->
        @include('company.sections.footer')
...
<!--    <script src="{{ asset('js/bootstrap.min.js') }}"></script>-->
    ...
    <!-- Master Select 2-->
    <script type="text/javascript" src="{{ asset('js/master_select/multiple-select.js') }}"></script>
