                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <span class="tools pull-right">
                            <a href="{{ url('company/ads/create') }}" class="btn btn-info btn-sm" data-toggle="tooltip" title="Add New Ad">
...
$("document").ready(function () {
        var datatable_url = "{{url('company/get-ads')}}"+'/'+0;
        var datatable_columns = [
            {data: 'time', time: 'time'},
            {data: 'preview', time: 'preview'},
