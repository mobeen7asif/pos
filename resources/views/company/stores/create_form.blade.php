            ...
            <div class="panel-body">
                <div class="position-center">
                    ...
                    <div class="form-group {{ $errors->has('break_time') ? 'has-error' : ''}}">
                        ...
                        <div class="col-lg-9">
                            <input name="set_break_time" type="checkbox" id="set_break_time" value="0">
                        ...
                        <input type="hidden" value="10:00 AM-12:00 PM" name="break_time" id="break_time">
                    </div>
                    ...
                    @if(isset($submitButtonText))
                        {!! Form::label('image', 'Logo', ['class' => 'col-lg-3 col-sm-3 control-label']) !!}
                    @else
                        {!! Form::label('image', 'Logo', ['class' => 'col-lg-3 col-sm-3 control-label required-input']) !!}
                    @endif
                    <div class="col-md-9">
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            ...
                            <div>
                                ...
                                <input id="image" type="file" class="default" name="image" accept="image/*"required />
                                </span>
                    ...
                    <div class="form-group {{ $errors->has('background_image') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <span class="fileupload-new"><i class="fa fa-paper-clip"></i> Select image</span>
                                <span class="fileupload-exists"><i class="fa fa-undo"></i> Change</span>
                                <input id="background_image" type="file" class="default" name="background_image" accept="image/*" required />
                                </span>
                                    <a href="#" class="btn btn-info fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i> Remove</a>
                                </div>
