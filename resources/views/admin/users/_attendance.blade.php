...
.unauthorized { background-color: #CEEEAB; }
.extra-work { background-color: #F5A623; }
      ...
      <div class="row" style="margin-top: 60px;">
        ...
        <div class="col-md-4"></div>
         <div class="col-md-4">
            ...
            <!-- /.progress-group -->
            <div class="progress-group">
              <span class="progress-text">Unauthorized</span>
              <span class="progress-number"><b id="unauthorized">0</b></span>
            ...
            <!-- /.progress-group -->
            <div class="progress-group">
              <span class="progress-text">Extra Work</span>
              <span class="progress-number"><b id="extra_work">0</b></span>
...
$("document").ready(function () {
    ...
    function navClicked(){
        setTimeout(function(){ 
            ...
            if($(".zabuto_calendar .event-styled .extra-work").hasClass("holidays")){
                $(".zabuto_calendar .event-styled .extra-work").removeClass("holidays")
            }
            ...
            var unauthorized = $(".zabuto_calendar .event-styled .unauthorized").length;
            var extra_work = $(".zabuto_calendar .event-styled .extra-work").length;
            var holidays = $(".zabuto_calendar .event-styled .holidays").length;

            $("#present").html(present);
            $("#leaves").html(leaves);
            $("#unauthorized").html(unauthorized);
            $("#extra_work").html(extra_work);
            ...
            var unauthorized_percentage = unauthorized/total_days_in_month*100;
            var extra_work_percentage = extra_work/total_days_in_month*100;
            ...
            $("#unauthorized").parents(".progress-group").find(".progress-bar").css("width",unauthorized_percentage+"%");
            $("#extra_work").parents(".progress-group").find(".progress-bar").css("width",extra_work_percentage+"%");
